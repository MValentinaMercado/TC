...
1. **Derivar**: reemplazar el no terminal superior por el lado derecho de una producción.
2. **Match**: cuando el terminal en la pila coincide con el token de entrada.
